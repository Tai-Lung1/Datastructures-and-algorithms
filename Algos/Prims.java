    ...
    public static void main(String[] args)
    {
        ...
        for(i=1;i<=n;i++)
            if(sol[i]==0)
                flag=1;
        if(flag==1)
            System.out.println("No connections among the thermal station(spanning tree)");
        else
        System.out.println("The cost of minimum connections among the thermal station(spanning tree) is "+sum);
                sc.close();
    }
}